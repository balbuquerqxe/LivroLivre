...
function insertInitialBooks() {
  const initial = [
    {titulo:"O Pequeno Príncipe",autor:"Antoine de Saint-Exupéry",
     doador:"mariana@example.com",chave:"GD6ZJ3PQ..."},
    {titulo:"1984",autor:"George Orwell",
     doador:"joao@example.com",chave:"GCEEU7S7..."},
    {titulo:"Dom Quixote",autor:"Miguel de Cervantes",
     doador:"fernanda@example.com",chave:"GAYJBEVF..."}
  ];
  const sql = `
  ...
  `;
  initial.forEach(b =>
    db.run(sql,[b.titulo,b.autor,b.doador,b.chave,null,null,JSON.stringify([]),
                'uploads/capa_padrao.png'])
  );
